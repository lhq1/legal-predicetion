...
import keras
from net.model.encoder.cnn_encoder import CNNEncoder
from net.model.decoder.lstm_article_decoder import LSTMArticleDecoder
...
class Topjudge(Model):
    def __init__(self, config, num1, num2):
        ...
        self.decoder = LSTMArticleDecoder(self.config, num1, num2)
